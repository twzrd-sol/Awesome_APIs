...
+ [TWZRD Agent Intel](https://intel.twzrd.xyz) - On-chain trust scoring for AI agent wallets on Solana. MCP server (`score_agent`, `preflight_check`) for verifying agent wallet identity and behavioral history before x402 micropayment-gated ML API access. [MCP](https://intel.twzrd.xyz/mcp)
...
+ [TWZRD Agent Intel](https://intel.twzrd.xyz) - Trust scoring and x402 micropayment verification API for AI agents on Solana. Free wallet scoring; paid trust receipts via HTTP 402 + USDC micropayment.
